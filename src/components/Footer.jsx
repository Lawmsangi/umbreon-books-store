    ...
    <div className='footer'>
        <div className="footer-links">
            <div className="footer-icons">
                <Link href="https://wa.me/6009766073" className='footer-link'>
                    <span>Contact via WhatsApp </span>
                    <FaWhatsapp className='footer-icon whatsapp-icon'/>
                </Link>
                <Link href="tel:+916009766073" className='footer-link'>
                    <span>Call Us </span>
            ...
            <div className="footer-icons">
                <Link href="mailto:lawmsangivarte22@gmail.com" className='footer-link'>
